...
INSERT INTO `admin_users` (`id`, `username`, `email`, `password`, `role`, `created_at`, `is_superadmin`)
VALUES (1, 'superadmin', 'admin@gmail.com', '$2y$12$C21d41rE94YhLzTwlwCNo.jWlyuFZUqbifV9VKVXSNJNZ.wcWXLzO',
        'superadmin', '2025-06-01 20:50:56', 1),
       (3, 'admin1', 'admin1@gmail.com', '$2y$12$q7GzNuYm1PHUJEYa4epHm.ZjwvUW75.7SzehxPBQZRQIJuZm6NQmO', 'admin',
        '2025-06-02 08:32:32', 1),
       (4, 'admin2', 'admin2@gmail.com', '$2y$12$poWJhaeeR0kZuaJ5hn7pnu4pmV18Ibmhri4QBO3.Cat5TAqSUg9VW', 'admin',
        '2025-06-02 08:33:08', 0);
...
VALUES (1, 'user1@gmail.com', '$2y$12$xoiOqZV2dB/YWAmDJUv8Cubd9zKlvjJuApqcdfkBwLLoEeTK2n2vq', 'User', 'basic',
        '2025-06-02 13:00:11'),
       (2, 'jonh@gmail.com', '$2y$12$mZ8F0Z5VTHaSCWE65OkyNOQ2BgpS6dtHFHfg0aloeuLK3ORRXUXwK', 'jonh', 'basic',
        '2025-06-03 10:45:14'),
       (3, 'ben@gmail.com', '$2y$12$FGwzT1/ACJQbSivgikHXluOoYjzh7ss3Y.euTZMGVn4tn361AAIym', 'Ben', 'basic',
        '2025-06-03 11:23:48'),
       (4, 'mayls@gmail.com', '$2y$12$/VI5upItLUD43it7yOhps.K8a9DC54JkNFoahLmEoSn.t71R.Ld7m', 'mayls', 'basic',
        '2025-06-03 11:43:00');
...
INSERT INTO `user_events` (`id`, `user_id`, `action`, `details`, `created_at`)
VALUES (1, 1, 'view-page', 'registration', '2025-06-02 16:00:11'),
       ...
       (120, 1, 'logout', 'user-logout', '2025-06-03 13:39:46'),
       (121, 2, 'view-page', 'registration', '2025-06-03 13:45:14'),
       (122, NULL, 'view-page', 'registration', '2025-06-03 13:45:14'),
       (123, NULL, 'view-page', 'login', '2025-06-03 13:55:55'),
       ...
       (130, NULL, 'logout', 'user-logout', '2025-06-03 14:23:14'),
       (131, 3, 'view-page', 'registration', '2025-06-03 14:23:48'),
       (132, NULL, 'view-page', 'registration', '2025-06-03 14:23:48'),
       (133, NULL, 'view-page', 'login', '2025-06-03 14:27:10'),
       ...
       (137, NULL, 'view-page', 'login', '2025-06-03 14:27:42'),
       ...
       (141, 3, 'logout', 'user-logout', '2025-06-03 14:28:07'),
       (142, 3, 'view-page', 'page-a', '2025-06-03 14:29:18'),
       (143, 3, 'logout', 'user-logout', '2025-06-03 14:29:20'),
       ...
       (150, NULL, 'view-page', 'login', '2025-06-03 14:41:11'),
       ...
       (157, 2, 'logout', 'user-logout', '2025-06-03 14:42:07'),
       (158, 4, 'view-page', 'registration', '2025-06-03 14:43:00'),
       (159, NULL, 'view-page', 'registration', '2025-06-03 14:43:00'),
       (160, NULL, 'view-page', 'login', '2025-06-03 14:43:27'),
       (161, 4, 'view-page', 'page-a', '2025-06-03 14:43:27'),
       (162, 4, 'logout', 'user-logout', '2025-06-03 14:43:33'),
       (163, NULL, 'view-page', 'page-b', '2025-06-03 14:56:19'),
       (164, NULL, 'view-page', 'page-b', '2025-06-03 15:54:35'),
       (165, NULL, 'view-page', 'login', '2025-06-03 15:54:43'),
       (166, 2, 'view-page', 'page-a', '2025-06-03 15:54:43'),
       (167, NULL, 'view-page', 'page-b', '2025-06-05 09:36:49'),
       (168, NULL, 'view-page', 'page-b', '2025-06-05 11:55:51'),
       (169, NULL, 'button-click', 'download', '2025-06-05 11:56:13'),
       (170, NULL, 'view-page', 'login', '2025-06-05 12:02:36'),
       (171, NULL, 'view-page', 'registration', '2025-06-05 12:06:44'),
       (172, NULL, 'view-page', 'registration', '2025-06-05 12:07:02'),
       (173, NULL, 'view-page', 'login', '2025-06-05 12:07:07'),
       (174, NULL, 'view-page', 'registration', '2025-06-05 12:07:10'),
       (175, NULL, 'view-page', 'page-b', '2025-06-05 13:00:46'),
       (176, NULL, 'view-page', 'page-b', '2025-06-05 13:00:46'),
       (177, NULL, 'view-page', 'registration', '2025-06-05 14:29:59'),
       (178, NULL, 'view-page', 'login', '2025-06-05 15:09:28'),
       (179, 1, 'view-page', 'page-a', '2025-06-05 15:20:07'),
       (180, 1, 'view-page', 'page-a', '2025-06-05 15:21:25'),
       (181, 1, 'view-page', 'page-a', '2025-06-05 15:23:36'),
       (182, 1, 'button-click', 'buy-cow', '2025-06-05 15:30:16'),
       (183, 1, 'view-page', 'page-a', '2025-06-05 15:30:16'),
       (184, 1, 'view-page', 'page-b', '2025-06-05 15:30:22'),
       (185, 1, 'button-click', 'download', '2025-06-05 15:30:28'),
       (186, 1, 'logout', 'user-logout', '2025-06-05 15:40:44'),
       (187, NULL, 'view-page', 'login', '2025-06-05 15:40:44'),
       (188, NULL, 'view-page', 'login', '2025-06-05 15:40:58'),
       (189, NULL, 'view-page', 'page-b', '2025-06-05 15:42:45'),
       (190, NULL, 'view-page', 'login', '2025-06-05 16:00:54'),
       (191, NULL, 'view-page', 'registration', '2025-06-05 16:00:55');
